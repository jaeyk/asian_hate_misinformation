...
nns_hate <- (con2nplot(subset(corpus, trump_speech == 0), c("chinesevirus"), local_glove, local_transform) + labs(title = "Pre-Trump tweet", subtitle = "Keyword: Chinese virus", col = "Label")) +
(con2nplot(subset(corpus, trump_speech == 1), c("chinesevirus"), local_glove, local_transform) + labs(title = "Post-Trump tweet", subtitle = "Keyword: Chinese virus", col = "Label"))
